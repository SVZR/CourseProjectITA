...
@WebFilter(servletNames = {"AddCoin", "AddNews", "Administration", "AllUsers", "ChangeUserRole",
        "DeleteNews", "DeleteUser"})
public class UserRoleFilter implements Filter {
    ...
    private boolean userAlreadyLoggedIn(ServletRequest httpRequest) {
        return !((HttpServletRequest) httpRequest).getSession().getAttribute("currentUserRole").equals("USER");
    }
